...
public class Cheesejava {
	...
	public static void main(String[] args) {
        ...
        //print the initial details of the pricing 
        ...
        double humboldtFogQty = Double.parseDouble(sc.nextLine());
        ...
        while(humboldtFogQty <= 0 || humboldtFogQty % 0.5 != 0){
            ...
            humboldtFogQty = Double.parseDouble(sc.nextLine());
        }
        ...
        double redHawkQty = Double.parseDouble(sc.nextLine());
        ...
        while(redHawkQty <= 0 || redHawkQty % 0.5 != 0){
            ...
            redHawkQty = Double.parseDouble(sc.nextLine());
        }
        ...
        double telemeQty = Double.parseDouble(sc.nextLine());
        ...
        while(telemeQty<= 0 || telemeQty % 0.5 != 0){
            ...
            telemeQty = Double.parseDouble(sc.nextLine());
        }
