public class Lab21_5 {
	...
	public static long squareSum(int max) {
		long sqreTotal=0, realTotal=0;
		for(int i=1; i<=max;i++) {
			sqreTotal=i*i;
			realTotal+= sqreTotal;
			System.out.println("squareSum "+i+" value "+ realTotal);
		}
		return realTotal;
	}
	...
	public static long fib(int max) {
		long Prev_first=0, Prev_sec=1, next=1;
		for (int i=2; i<=max; i++) {
			next = Prev_first + Prev_sec;
			Prev_first= Prev_sec;
			Prev_sec = next;
			System.out.println("Fibonacci "+i+" value "+ next);	
		}
		return next;
	}
	...
	public static long factorial(int max) {
		long subTot=1,realTot=0;
		for (int i=2; i <=max; i++) {
			
			realTot=i*subTot;
			
		System.out.println("Factorial "+i+" value "+realTot);
		 subTot=realTot;
		}
		return realTot;
	}
